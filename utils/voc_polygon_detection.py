...
class VOCPolygonMApMetric:
    ...
    def update(self, pred_bboxes, pred_centers, pred_coefs, pred_labels, pred_scores,
               gt_bboxes, gt_points_xs, gt_points_ys, gt_labels):

        for pred_bbox, pred_center, pred_coef, pred_label, pred_score, gt_bbox, gt_points_xs, gt_points_ys, gt_label in zip(
                *[x for x in [pred_bboxes, pred_centers, pred_coefs, pred_labels, pred_scores,
                                        gt_bboxes, gt_points_xs, gt_points_ys, gt_labels]]):
